...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="@ASTRONAUT_OFFICIAL_1")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="@Astronaut_OFFICIAL_2"),
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"Welcome ASTRONAUT txt Uploader bot-  [Astronaut](@Astronaut_OFFICIAL_2)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:
                ...
                await bot.send_message(channel_id, f'{link0} disable_web_page_preview=True)
                count += 1
                failed_count += 1
                continue
